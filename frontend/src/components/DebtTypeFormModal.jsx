...
import { X, Tags, Pencil } from 'lucide-react';
import LoadingButton from './LoadingButton';

export const EMPTY_DEBT_TYPE_FORM = {
  name: '',
  code: '',
  description: '',
  isActive: true,
...
function DebtTypeFormModal({ open, onClose, form, setForm, isSaving, onSave, isEditing = false }) {
  ...
  return (
    <div className="modal-backdrop modal-backdrop-static" role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="debt-type-modal-title"
      >
          ...
          <div className="cf-header-identity">
            <div className="cf-header-icon" aria-hidden="true">
              {isEditing
                ...
                : <Tags className="cf-header-icon-svg" />}
            </div>
            <div>
              <h2 id="debt-type-modal-title" className="cf-title">
                {isEditing ? 'Edit Debt Type' : 'Add Debt Type'}
              </h2>
              <p className="cf-subtitle">
                Classify the lifecycle state of a debt — e.g. Live, Write off, Digital Loan.
              </p>
            </div>
          </div>
        ...
        <div className="cf-body">
          ...
          <div className="cf-field">
            ...
            <input
              ...
              placeholder="Short description of this debt type"
            />
          </div>
        ...
        <div className="cf-footer">
          ...
          <LoadingButton
            ...
            loadingText="Saving…"
          >
            {isEditing ? 'Save Changes' : 'Add Debt Type'}
          </LoadingButton>
        </div>
      </div>
    </div>
...
export default DebtTypeFormModal;
