...
export const EMPTY_AGENT_EXPERTISE_FORM = {
  name: '',
  code: '',
  description: '',
  isActive: true,
...
function AgentExpertiseAreaFormModal({
  open,
  onClose,
  form,
  setForm,
  ...
  return (
    <div className="modal-backdrop modal-backdrop-static" role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="agent-expertise-modal-title"
      >
          ...
          <div className="cf-header-identity">
            <div className="cf-header-icon" aria-hidden="true">
              {isEditing
                ...
                : <Briefcase className="cf-header-icon-svg" />}
            </div>
            <div>
              <h2 id="agent-expertise-modal-title" className="cf-title">
                {isEditing ? 'Edit Expertise Area' : 'Add Expertise Area'}
              </h2>
              <p className="cf-subtitle">
                Tag agents by specialisation for rule-based case assignment.
              </p>
            </div>
          </div>
        ...
        <div className="cf-body">
          ...
          <div className="cf-field">
            ...
            <input
              ...
              placeholder="Short description of this expertise area"
            />
          </div>
...
export default AgentExpertiseAreaFormModal;
