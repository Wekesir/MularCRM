...
export const EMPTY_AGENT_EXPERIENCE_FORM = {
  name: '',
  code: '',
  description: '',
  isActive: true,
...
function AgentExperienceLevelFormModal({
  open,
  onClose,
  form,
  setForm,
  ...
  return (
    <div className="modal-backdrop modal-backdrop-static" role="presentation">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="agent-exp-modal-title"
      >
          ...
          <div className="cf-header-identity">
            <div className="cf-header-icon" aria-hidden="true">
              {isEditing
                ...
                : <GraduationCap className="cf-header-icon-svg" />}
            </div>
            <div>
              <h2 id="agent-exp-modal-title" className="cf-title">
                {isEditing ? 'Edit Experience Level' : 'Add Experience Level'}
              </h2>
              <p className="cf-subtitle">
                Classify agents by seniority for rule-based case assignment.
              </p>
            </div>
          </div>
        ...
        <div className="cf-body">
          ...
          <div className="cf-field">
            ...
            <input
              ...
              placeholder="Short description of this experience level"
            />
          </div>
...
export default AgentExperienceLevelFormModal;
