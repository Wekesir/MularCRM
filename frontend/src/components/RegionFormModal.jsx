...
export const EMPTY_REGION_FORM = {
  name: '',
  code: '',
  description: '',
  isActive: true,
...
function RegionFormModal({ open, onClose, form, setForm, isSaving, onSave, isEditing = false }) {
        ...
        <div className="cf-header">
          <div className="cf-header-identity">
            <div className="cf-header-icon" aria-hidden="true">
              {isEditing ? <Pencil className="cf-header-icon-svg" /> : <MapPin className="cf-header-icon-svg" />}
            </div>
            <div>
              <h2 id="region-modal-title" className="cf-title">
                {isEditing ? 'Edit Region' : 'Add Region'}
              </h2>
              <p className="cf-subtitle">
                Geographic areas used to bind call centers to a region.
              </p>
            </div>
          </div>
